...
visual_encoder_path=../checkpoint/visual_encoder/    # please download the pretrained vsr encoder here(https://www.modelscope.cn/models/chenchen2121/CNVSRC2024Baseline/files  model_name: model_avg_cncvs_cnvsrc-single.pth)
export DEBUG_MODE
